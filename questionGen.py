...
def question_gen():
    ...
    filtered_split_text = [(game_split_txt[i],game_split_txt[i+1]) for i in range(0,int(len(game_split_txt)), 2) if "Classical" in game_split_txt[i] and len(game_split_txt[i+1].split())]
